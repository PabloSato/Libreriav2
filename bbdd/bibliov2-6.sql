...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2021 a las 11:02:04
...
ALTER TABLE `libro_balda`
  ...
  ADD CONSTRAINT `libro_bal_est_fk3` FOREIGN KEY (`estanteria`) REFERENCES `estanteria` (`nombre`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `libro_bal_libro_fk2` FOREIGN KEY (`libro`) REFERENCES `libro` (`titulo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `libro_bal_ubic_fk4` FOREIGN KEY (`ubicacion`) REFERENCES `ubicacion` (`nombre`) ON DELETE CASCADE ON UPDATE CASCADE;
